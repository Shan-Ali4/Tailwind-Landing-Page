  ...
  return (
    <div className='space-y-4 lg:flex'>
      <div className='flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end'>
        ...
        <img src="./assets/Pink-Shape.svg" alt="2nd" className='absolute -rotate-30 h-64 md:h-72 lg:h-[400px]' />
        <img src="./assets/Purple-Shape.svg" alt="3rd" className='absolute -rotate-15 h-64 md:h-72 lg:h-[400px]' />
      ...
      <div className='lg:flex-1 lg:order-1'>
        ...
        <form action="" className='flex flex-col gap-4 md:flex-row'>
          <input className='rounded-md px-4 py-3 placeholder:text-gray-400 bg-white' type="email" placeholder="Enter your email" />
